package top.yuany3721.BulletBotServer;
...
import top.yuany3721.BulletBotServer.annotation.AnnotationUtil;
import top.yuany3721.BulletBotServer.listener.ListenerLoader;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        while (!loadFlag && retry < BaseProperties.retryTimes) {
             bot = BotFactory.INSTANCE.newBot(BaseProperties.qq, BaseProperties.password,
