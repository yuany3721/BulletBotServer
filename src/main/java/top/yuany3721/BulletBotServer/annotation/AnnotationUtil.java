package top.yuany3721.BulletBotServer.annotation;

import net.mamoe.mirai.Bot;
import net.mamoe.mirai.contact.Group;
import top.yuany3721.BulletBotServer.buffer.FunctionSwitchBuffer;
...
public class AnnotationUtil {
    ...
    public static void main(String[] args) {
        String packageName = "top.yuany3721.BulletBotServer.function";
